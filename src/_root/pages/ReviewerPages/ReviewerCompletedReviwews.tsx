...
const ReviewerCompletedReviwews = () => {
  ...
  return (
    <div className=' justify-center items-center'>
      <div className='  flex justify-between items-start'>
        <h2 className='font-roboto text-dashboard-page-header-purple  text-3xl font-semibold py-16 px-16'>Completed Reviews</h2>
...
export default ReviewerCompletedReviwews