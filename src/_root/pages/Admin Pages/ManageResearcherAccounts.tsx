...
const ManageResearcherAccounts = () => {
  ...
  <div className='  flex justify-between items-start'>
    <h2 className='font-roboto text-dashboard-page-header-purple  text-3xl font-semibold py-16 px-16'>Researcher Accounts</h2>
      ...
      <TableContainer overflowY="auto">
        {searchValue ? (
          <Table variant="striped" colorScheme="gray" className="min-w-full divide-y divide-gray-300">
            ...
            <Tbody>
              {filteredRows.map(({ name, reviewerEmail, phone, dateCreated, discipline, papersSubmitted }, index) => (
                <Tr key={index}>
                    ...
                    <Td className="px-6 py-4 whitespace-nowrap">{papersSubmitted}</Td>
            ...
            <Tbody>
            {currentData.map(({ name, reviewerEmail, phone, dateCreated, discipline, papersSubmitted }, index) => (
                <Tr key={index}>
                  <Td className="px-6 py-4 whitespace-nowrap">{name}</Td>
                  <Td className="px-6 py-4 whitespace-nowrap">{reviewerEmail}</Td>
                  <Td className="px-6 py-4 whitespace-nowrap">{phone}</Td>
...
export default ManageResearcherAccounts